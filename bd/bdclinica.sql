...
salario_decimal(8,2) not null default(1510.00),
...
crm int not null,
constraint PK_Consultas primary key(codico_consulta),
constraint FK_ConsultasMedicos foreign key (crm) references medicos(crm),
constraint FK_ConsultasPacientes foreign key (cpf) references paciente(cpf));
